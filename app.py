...
model = joblib.load("train_price_model.joblib")  # Changed from pickle to joblib

# Load label encoders
label_encoders = joblib.load("label_encoders.joblib")  # Changed from pickle to joblib
